...
FEEDS = [
    {"url": "https://news.google.com/rss/search?q=Kenya+tea+prices+OR+KTDA+auction&hl=en-KE&gl=KE&ceid=KE:en", "category": "Market & Prices"},
    {"url": "https://news.google.com/rss/search?q=Kericho+tea+farmers&hl=en-KE&gl=KE&ceid=KE:en", "category": "Kericho & Local"},
    {"url": "https://news.google.com/rss/search?q=tea+farming+East+Africa&hl=en-KE&gl=KE&ceid=KE:en", "category": "Regional Farming"},
    {"url": "https://news.google.com/rss/search?q=global+tea+market+OR+tea+export&hl=en&gl=KE&ceid=KE:en", "category": "Global Tea Market"},
]
...
def tea_news():
    ...
    return render_template("news.html", featured=featured, articles=rest, categories=categories)
